...
import umc7.spring.service.memberMissionService.MemberMissionQueryService;
...
public class MissionRestController {
    ...
    @GetMapping("/challengingMissions")
    ...
    public ApiResponse<MissionResponseDTO.MissionPreviewListDto> getChallengingMissionList(@ExistMember @RequestParam(name = "memberId") Long memberId,
                                                                                           @CheckPage @RequestParam(name = "page", defaultValue = "1") Integer page) {
        Page<Mission> memberMissionList = memberMissionQueryService.getChallengingMissionList(memberId, page - 1);
